...
const DescriptionPage = () => {
  return (
    <div>
      <div className="description__header"></div>
      <Container className='container'>
        <div className="description__content">
          <h2 className="description__content_title">The 2020 World's Most Valuable Brands</h2>
          <div className="description__content_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Interdum ornare convallis non etiam tincidunt tincidunt. Non dolor vel purus id. Blandit habitasse volutpat id dolor pretium, sem iaculis. Faucibus commodo mauris enim, turpis blandit.
            ...
            Porttitor facilisi viverra mi lacus lacinia accumsan. Pellentesque gravida ligula bibendum aliquet nulla massa elit. Ac faucibus donec sit morbi pharetra urna. Vel facilisis amet placerat ultrices lobortis proin nulla. </div>
        </div>
